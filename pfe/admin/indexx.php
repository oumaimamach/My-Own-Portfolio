  ...
  <div class="main_container">
      <div class="sidebar">
          <div class="sidebar__inner">
             <ul>
              ...
              <li>
                <a href="indexx.php" class="active">
    ...
    <div class="container">
        ...
        <table class="table table-dark table-hover table-bordered table-responsive-xl">
            ...
            $Circuits = $common->getAllCircuits($connection);
            if ($Trips->num_rows>0){
                $sr = 1;
                while ($Trip = $Trips->fetch_object()) {
                	$Circuit = $Circuits->fetch_object();
                	$circuitId= $Trip->idCircuit;
                    $touroperator = $Trip->NomTourOperateur;
                    $departdate= $Trip->dateDepart;
                    $places = $Trip->nbPlaces;
                    $departcity= $Circuit->villeDepart;
                    $arrivecity= $Circuit->villeArrivee;
                    $traveltime= $Circuit->dureeCircuit;
                    $price= $Circuit->prix;
                    ?>
                    <tr>
                        <th><?php echo $sr;?></th>
                        ...
                        <td style="padding-left: 20px;"><a style = "margin-left: 10px;"href="delete-script.php?circuitId=<?php echo $circuitId ?>" class="btn btn-secondary" >Delete</a></td>
                    </tr>
                    <?php
                    $sr++;
